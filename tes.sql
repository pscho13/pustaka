...
INSERT INTO `buku` (`BukuID`, `Judul`, `Penulis`, `Penerbit`, `TahunTerbit`, `Cover`, `updated_by`) VALUES
(1, 'matematika', 'saya', 'tidak diketahui', 2024, 'public/img/cover_67449b9ee54d85.29328791.jpg', NULL),
(2, 'buku tanpa nama', 'saya', 'tidak diketahui', 2000, 'public/img/cover_6747ecb53dc815.58448716.jpg', 'admin'),
(3, 'matematika', 'saya', 'tidak diketahui', 2000, 'public/img/cover_674ba6fbc05532.46850896.jpg', 'admin');
...
INSERT INTO `users` (`UserID`, `Username`, `Password`, `Email`, `NamaLengkap`, `Alamat`, `Role`, `update_by`, `no_hp`) VALUES
(27, 'admin', '$2y$10$tH0ogzIaehL2TYd4mc92ue1vv8BwmYn3dCBE/fVgA.dpFXdh/Un3m', 'admin@gmail.com', 'admin', 'hashahahhdadff', 'Administrator', NULL, NULL),
(28, 'petugas 1', '$2y$10$zBH0ja8QtRsS44vDDWTZY.GB3lSCdtFcwi5089FrkXbqKiACRAoHq', 'petugas1@gmail.com', 'petugas 1', 'aaddadda', 'Petugas', NULL, NULL),
(29, 'peminjam', '$2y$10$pPRqfweulvKyTnP7fUKThe1N.Qy/C0.iluQ0MLELr3TehLHtodiK.', 'peminjam@gmail.com', 'peminjam 1', 'dsdfggdsf', 'Peminjam', 'admin', 2147483647),
(30, 'peminjam 2', '$2y$10$ADtZ38zHCREbVSPRiVXXfOfhHS5ncjfqgMY/Z.P0vaCKMFttXHL5C', 'peminjam2@gmail.com', 'peminjam 2', 'hfdjsk', 'Peminjam', 'admin', 2147483647);
